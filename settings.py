...
TITLE = "Capitalism simulator!"  # Game window title text (Default: "Capitalism simulator!")
...
PLAYER_SPEED = 300  # Player movement speed (Default: 200)
...
NPC_DATA = {
    ...
    "Poker person": {
        "pos": (2500, 410),  # Default spawn position
        "graphic": "graphics/objects/merchant.png",  # Placeholder using existing asset (Default: "graphics/objects/merchant.png")
        "dialogue": [
            "Psst",
            "Hey, you.",
